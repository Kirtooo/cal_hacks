...
def put_arr_course(non_filter_result_list, base):
    for i in non_filter_result_list:
        ...
        for j in i:
            ...
            for day in [1, 2, 3, 4, 5]:
                ...
                if day in time.keys():
                    # print(day)
                    for k in range(int(time[day][0] * 2), int(time[day][1] * 2)):
                        if (two_d_array[day][k] == True):
                            non_filter_result_list.remove(i)
                            remove = True
                            break
                            # print("yessss")
                        else:
...
=======
    # print(two_d_array)
    return two_d_array
>>>>>>> 0d5b42b713bda0c464360e72227b24d89f96698a
